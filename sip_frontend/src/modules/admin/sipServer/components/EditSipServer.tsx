...
const EditSipServer: React.FC<Props> = ({ data, getAllData }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch('http://localhost:3000/sipServer/update/' + formData.id, {
            method: 'PUT',
            headers: {
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                <h3 className="text-3xl font-semibold">Edit SIP Server</h3>
                                <button
