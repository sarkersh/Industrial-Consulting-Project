...
const EditAdvanceSettings: React.FC<Props> = ({ data, getAllData }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch('http://localhost:3000/advanceSettings/update/' + formData.mac, {
            method: 'PUT',
            headers: {
...
export default EditAdvanceSettings;
