...
interface Props {
    ...
    getAllData: any; // The function to call to get all data from the database
}

// Define the component function
const EditDeviceAdmin: React.FC<Props> = ({ data, getAllData }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch('http://localhost:3000/deviceAdmin/update/' + formData.mac, {
            method: 'PUT',
            headers: {
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                <h3 className="text-3xl font-semibold">Edit Device Admin</h3>
                                <button
...
export default EditDeviceAdmin;
